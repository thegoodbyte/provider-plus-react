...
const MedicalGrid = lazy(() => import('./MedicalGrid'));
const MedicalTrackingNew = lazy(() => import('./MedicalTrackingNew'));
const MedicalArtifactsPage = lazy(() => import('./MedicalArtifactsPage'));
const MedicalArtifactCreatePage = lazy(() => import('./MedicalArtifactCreatePage'));
const MedicalArtifactDetailPage = lazy(() => import('./MedicalArtifactDetailPage'));
const MedicalArtifactFileViewPage = lazy(() => import('./MedicalArtifactFileViewPage'));
const MedicalTrackingCreatePage = lazy(() => import('./MedicalTrackingCreatePage'));
const MedicalTrackingDetail = lazy(() => import('./MedicalTrackingDetail'));
const MedicalTrackingEditPage = lazy(() => import('./MedicalTrackingEditPage'));
const MedicalTrackingFileViewPage = lazy(() => import('./MedicalTrackingFileViewPage'));
const MedicalReviewRequestsGrid = lazy(() => import('./MedicalReviewRequestsGrid'));
const MedicalReviewRequestEditorPage = lazy(() => import('./MedicalReviewRequestEditorPage'));
const MedicalReviewRequestsPage = lazy(() => import('./MedicalReviewRequestsPage'));
const MedicalReviewAccessPage = lazy(() => import('./MedicalReviewAccessPage'));
const MedicalReviewGroupPage = lazy(() => import('./MedicalReviewGroupPage'));
const MedicalReviewPublicPage = lazy(() => import('./MedicalReviewPublicPage'));
const MedicalAdvisorDashboard = lazy(() => import('./MedicalAdvisorDashboard'));
const MedicalReviewDetail = lazy(() => import('./MedicalReviewDetail'));
const MedicalRetreats = lazy(() => import('./MedicalRetreats'));
const MedicalProfile = lazy(() => import('./MedicalProfile'));
const MedicalClientView = lazy(() => import('./MedicalClientView'));
const MedicalAdvisorReview = lazy(() => import('./MedicalAdvisorReview'));
const CommunicationsPage = lazy(() => import('./CommunicationsPage'));
const AnalyticsPage = lazy(() => import('./AnalyticsPage'));
const UserManagement = lazy(() => import('./UserManagement'));
const AuditLogsPage = lazy(() => import('./AuditLogsPage'));
const DataBackupPage = lazy(() => import('./DataBackupPage'));
const PermissionsMatrix = lazy(() => import('./PermissionsMatrix'));
const CurrencySettings = lazy(() => import('./CurrencySettings'));
const ExpenseTypesSettings = lazy(() => import('./ExpenseTypesSettings'));
const PaymentRequestTypesSettings = lazy(() => import('./PaymentRequestTypesSettings'));
