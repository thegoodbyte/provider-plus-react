...
const BookingDetailShell: React.FC<Props> = (props) => <>
  ...
  <div className="booking-info-strip" aria-label="Booking summary"><div className="booking-info-item booking-info-client"><span>Client</span><strong>{props.clientName}</strong></div>{props.clientDisplayId && <div className="booking-info-item"><span>Client ID</span>{props.clientId ? <button type="button" className="booking-info-link" onClick={props.onOpenClient} title={`Open client #${props.clientDisplayId}`}>#{props.clientDisplayId}</button> : <strong>#{props.clientDisplayId}</strong>}</div>}<div className="booking-info-item"><span>Retreat</span>{props.retreatId ? <button type="button" className="booking-info-link" onClick={props.onOpenRetreat} title={`Open retreat ${props.retreatCode}`}>{props.retreatCode}</button> : <strong>{props.retreatCode}</strong>}</div><div className="booking-info-item booking-info-type"><span>Type</span><strong>{props.bookingTypeCode}</strong></div></div>
