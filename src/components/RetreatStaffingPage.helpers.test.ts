...
describe('RetreatStaffingPage helpers', () => {
  ...
  it('formats retreat and staff dates with weekdays, times, and retreat fallbacks', () => {
    ...
    expect(formatRetreatStaffingDates(retreat)).toBe('Tue, 09/22/2026 – Tue, 09/29/2026');
    expect(formatStaffAssignmentDates({}, retreat)).toBe('Tue, 09/22/2026 · 18:00 → Tue, 09/29/2026 · 10:00');
